...
- Headings in the blog post can be directly linked to. An easy way to copy these links is currently missing.
...
- Blog posts might be lengthy. Having a table of contents would be good.
